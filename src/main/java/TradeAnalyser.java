...
public class TradeAnalyser {
    ...
    private static Pipeline buildPipeline() {
        ...
        StreamStage<Trade> source = p
                .drawFrom(KafkaSources.<String, String, Trade>kafka(
...
//        avg1s.drainTo(influxDbSink);
    ...
    private static JetConfig getConfiguration() {
        JetConfig jetConfig = new JetConfig();
        jetConfig.getHazelcastConfig().setLicenseKey("ENTER LICENSE KEY HERE");
        return jetConfig;
    }
